...
def main(mock: bool = False) -> None:
    ...
    if not fresh:
        ...
        return
    print(f"Fetched {len(fresh)} new papers.")
    ...
    if can_train:
        ...
        print("Not enough labeled history yet to train a challenger; "
              "accumulating data this run.")
...
if __name__ == "__main__":
    ...
    ap.add_argument("--mock", action="store_true",
                    help="Label with a keyword heuristic instead of Claude "
